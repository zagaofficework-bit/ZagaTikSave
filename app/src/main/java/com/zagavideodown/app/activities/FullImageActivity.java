...
import com.zagavideodown.app.databinding.ActivityFullViewBinding;
...
public class FullImageActivity extends AppCompatActivity {
    ...
    public void showImage(String str) {
        Glide.with(this).asBitmap().load(str).placeholder(R.drawable.ic_launcher).addListener(new RequestListener<>() {
            public boolean onLoadFailed(GlideException glideException, Object obj, Target<Bitmap> target, boolean z) {
                Utils.ShowToast(FullImageActivity.this, "Cant get image");
                return false;
            }
