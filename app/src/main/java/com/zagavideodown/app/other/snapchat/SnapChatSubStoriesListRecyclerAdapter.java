...
import com.zagavideodown.app.activities.FullImageActivity;
import com.zagavideodown.app.activities.VideoPlayActivity;
...
public class SnapChatSubStoriesListRecyclerAdapter extends RecyclerView.Adapter<SnapChatSubStoriesListRecyclerAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder myViewHolder, int i) {
        ...
        ((RequestBuilder) Glide.with(context).load(FBStory).transform(new Transformation[]{new CenterCrop(), new RoundedCorners(15)})).into(myViewHolder.thumb);
        ...
        if (str.toLowerCase().contains(".jpg")) {
            ...
            try {
                ...
                context.runOnUiThread(() -> {
                    Utils.ShowToastError(context, "No application found to open this file."
                    );
                });
